...
package com.logan20.droneforceshared.droneforceshared.ARdroneAPI.data.decoder.ardrone10.navdata;

import com.logan20.droneforceshared.droneforceshared.ARdroneAPI.NavData;
...
import com.logan20.droneforceshared.droneforceshared.ARdroneAPI.data.navdata.NavDataFormatException;
import com.logan20.droneforceshared.droneforceshared.ARdroneAPI.data.navdata.NavDataTag;
import com.logan20.droneforceshared.droneforceshared.ARdroneAPI.data.navdata.vision.Dimension;
import com.logan20.droneforceshared.droneforceshared.ARdroneAPI.data.navdata.vision.Point;
...
public class ARDrone10NavData implements NavData
{
    ...
    private static List<VisionTag> parseVisionTags(NavData data, ByteBuffer buf, int offset) throws NavDataFormatException
    {
        ...
        for(int i = 0; i < nb_detected; i++)
        {
            ...
            VisionTag vt = new VisionTag(VisionTag.VisionTagType.fromInt(type), new Point(xc, yc), new Dimension(width, height),
                    dist);
