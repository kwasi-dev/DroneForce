...
public class MainActivity extends Activity implements com.codeminders.ardrone.DroneVideoListener, OnSharedPreferenceChangeListener {
    
    private static final long CONNECTION_TIMEOUT = 10000;
  
    static com.codeminders.ardrone.ARDrone drone;
...
private class DroneStarter extends AsyncTask<com.codeminders.ardrone.ARDrone, Integer, Boolean> {
    
    @Override
    protected Boolean doInBackground(com.codeminders.ardrone.ARDrone... drones) {
        com.codeminders.ardrone.ARDrone drone = drones[0];
        try {
            drone = new com.codeminders.ardrone.ARDrone(InetAddress.getByAddress(com.codeminders.ardrone.ARDrone.DEFAULT_DRONE_IP), 10000, 60000);
            ...
            drone.selectVideoChannel(com.codeminders.ardrone.ARDrone.VideoChannel.HORIZONTAL_ONLY);
